...
你可能會對「作業系統」或「核心」的開發感到畏懼，但其實作業系統（特別是核心）的基本功能出奇地簡單。即使是常被認為龐大的開源軟體 Linux，在 0.01 版本時也只有 8413 行程式碼。如今的 Linux 核心規模龐大，但它一開始也只是個規模很小的程式碼，就像你的 side project 一樣。
...
> [!TIP]
>
> 如果你想打造一個 hypervisor，或是想用 Rust 程式語言來挑戰本教學，請參考 [Hypervisor in 1,000 Lines](https://1000hv.seiya.me/)。
